...
export function MCPUsagePage() {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case 'rate_limited': return <AlertCircle className="h-4 w-4 text-yellow-600 dark:text-yellow-400" />;
                ...
                <div className="flex items-center mt-1 text-sm">
                  {callsChange >= 0 ? (
                    <>
                      ...
                      <span className="text-green-600 dark:text-green-400">+{callsChange}%</span>
                    </>
                  ) : (
                    <>
                      <ArrowDownRight className="h-4 w-4 text-red-600 dark:text-red-400" />
                      <span className="text-red-600 dark:text-red-400">{callsChange}%</span>
                    </>
                  )}
          ...
          <CardContent className="p-6">
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="flex items-center mt-1 text-sm">
                  <ArrowUpRight className="h-4 w-4 text-green-600 dark:text-green-400" />
                  <span className="text-green-600 dark:text-green-400">+{successRateChange}%</span>
                  <span className="text-muted-foreground ml-1">vs last period</span>
                </div>
              </div>
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="flex items-center mt-1 text-sm">
                  ...
                  <span className="text-green-600 dark:text-green-400">{responseTimeChange}%</span>
                  <span className="text-muted-foreground ml-1">vs last period</span>
                </div>
              </div>
              ...
              <tbody>
                {mockRecentLogs.map((log) => (
                  <tr key={log.id} className="border-b border-border hover:bg-muted/50">
                    ...
                    <td className="py-3 px-2 text-foreground">{log.response_time_ms}ms</td>
