...
const mockCatalogServices: MCPServiceCatalog[] = [
  ...
  },
  {
    ...
    oauth_url: '/oauth/authorize?client_id=LanOnasis-mcp-cli&response_type=code&redirect_uri=https%3A%2F%2Fdashboard.lanonasis.com%2Fauth%2Fcallback&scope=mcp%3Aread%20mcp%3Awrite%20api_keys%3Amanage',
    auth_type: 'both',
    is_available: true,
    is_beta: false,
    requires_approval: false,
  ...
  },
  {
    ...
    mcp_args: [],
    mcp_env_mapping: { api_key: 'OPENAI_API_KEY' },
  ...
  },
  {
    ...
    oauth_url: '/oauth/authorize?client_id=LanOnasis-mcp-cli&response_type=code&redirect_uri=https%3A%2F%2Fdashboard.lanonasis.com%2Fauth%2Fcallback&scope=mcp%3Aread%20mcp%3Awrite',
    auth_type: 'oauth',
    is_available: true,
    is_beta: false,
    requires_approval: false,
