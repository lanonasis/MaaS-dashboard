...
#### Google
- Redirect URI: `https://[YOUR_SUPABASE_URL=https://<project-ref>.supabase.co

#### GitHub  
- Authorization callback URL: `https://[YOUR_SUPABASE_URL=https://<project-ref>.supabase.co

#### LinkedIn
- Redirect URLs: `https://[YOUR_SUPABASE_URL=https://<project-ref>.supabase.co

#### Discord
- Redirects: `https://[YOUR_SUPABASE_URL=https://<project-ref>.supabase.co
